...
var header = "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>{{FILENAME}}</title><style>" + css + "</style><style>{ANIMATE}</style></head><body style='display:none;'><div class='slide'>";
